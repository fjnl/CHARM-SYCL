...
int cc1_main(ArrayRef<const char *> Argv, const char *Argv0, void *MainAddr) {
  ...
  // Modification for CHARM-SYCL starts
  // Copyright (c) 2023, CHARM-SYCL contributors
  extern void cscc_install_vfs(clang::CompilerInstance&);
  cscc_install_vfs(*Clang);
  // Modification for CHARM-SYCL ends
